    ...
    stages {
        ...
        stage('AnsiblePlaybook for Docker Container') {
            steps {
                ...
                ansiblePlaybook credentialsId: 'radikey', disableHostKeyChecking: true, installation: 'ansible', inventory: '/var/lib/jenkins/workspace/trs/invent.txt', playbook: '/var/lib/jenkins/workspace/trs/deployApp.yaml'
            }
        }
